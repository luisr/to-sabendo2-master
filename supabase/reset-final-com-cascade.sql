-- =============================================================================
-- PROJETO: TO SABENDO
-- SCRIPT DE RESET DEFINITIVO COM CASCADE - A SOLUÇÃO FINAL
-- =============================================================================

-- =============================================================================
-- ETAPA 1: REMOÇÃO COMPLETA E EM CASCATA DAS FUNÇÕES E POLÍTICAS DEPENDENTES
-- O comando CASCADE é a chave: ele remove as funções E todas as políticas que dependem delas.
-- Isso limpa o estado inconsistente do banco de dados de uma vez por todas.
-- =============================================================================
...
-- =============================================================================
-- ETAPA 2: RECRIAR FUNÇÕES SEGURAS (COM PROTEÇÃO ANTI-RECURSÃO)
-- =============================================================================
...
-- =============================================================================
-- ETAPA 3: RECRIAR POLÍTICAS DE RLS DEFINITIVAS
-- =============================================================================
...
-- Tabela: collaborators (A CHAVE DA SOLUÇÃO ANTI-RECURSÃO)
