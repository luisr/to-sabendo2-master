-- =============================================================================
--  MIGRAÇÃO 041: RECONSTRUÇÃO ARQUITETURAL FINAL E DEFINITIVA DA RLS
...
--  resolvendo o erro de "infinite recursion" na tabela 'users'.
-- =============================================================================
...
-- 2. RECRIAR TODAS AS POLÍTICAS DE FORMA SEGURA E NÃO-RECURSIVA

-- Para 'users' (CORREÇÃO CRÍTICA DA RECURSÃO)
