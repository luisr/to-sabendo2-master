-- =============================================================================
--  MIGRAÇÃO 040: SCRIPT MESTRE FINAL E IDEMPOTENTE PARA RECONSTRUÇÃO DA RLS
...
-- 1. LIMPEZA COMPLETA DE TODAS AS POLÍTICAS POSSÍVEIS (IDEMPOTENTE)
...
-- 2. REMOVER AS FUNÇÕES AUXILIARES (SE EXISTIREM)
