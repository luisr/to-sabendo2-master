-- =============================================================================
--  MIGRAÇÃO 029: CORREÇÃO DEFINITIVA DE DEPENDÊNCIAS DE RLS
--  Este script remove TODAS as políticas que dependem das funções auxiliares
--  problemáticas, remove as funções, e então recria as políticas de forma
--  segura e não-recursiva para TODAS as tabelas relevantes.
-- =============================================================================

-- 1. LIMPEZA COMPLETA E ORDENADA DAS POLÍTICAS DEPENDENTES
-- É crucial remover estas primeiro para que as funções possam ser dropadas.
...
-- Agora que nenhuma política depende mais delas, isso será executado com sucesso.
