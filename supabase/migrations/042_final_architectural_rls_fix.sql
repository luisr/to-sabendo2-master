-- =============================================================================
--  MIGRAÇÃO 042: RECONSTRUÇÃO FINAL E CONSOLIDADA DA ARQUITETURA DE RLS
--  Este script limpa todas as políticas antigas, recria as funções auxiliares
--  com o contexto de segurança correto (SECURITY DEFINER) e implementa as
--  políticas granulares e não-recursivas para cada perfil.
-- =============================================================================
...
DROP POLICY IF EXISTS "Membros podem atualizar suas próprias tarefas" ON public.tasks;
