-- =============================================================================
-- PROJETO: TO SABENDO
-- SCRIPT DE SETUP DE PRODUÇÃO v2 - CORREÇÃO DEFINITIVA PARA COLLABORATORS
-- =============================================================================

-- =============================================================================
-- ETAPA 1: LIMPEZA COMPLETA E EM CASCATA
-- =============================================================================
...
-- =============================================================================
-- ETAPA 2: LIMPEZA MANUAL ADICIONAL (GARANTIA)
-- =============================================================================
...
CREATE POLICY "Membros do projeto podem ver a equipe" ON public.collaborators
  FOR SELECT USING (
    -- Um usuário pode ver colaboradores de um projeto se o ID daquele projeto
    -- estiver na lista de projetos dos quais ele faz parte.
    project_id IN (SELECT project_id FROM public.collaborators WHERE user_id = public.uid_safe())
  );
