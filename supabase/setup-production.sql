-- =============================================================================
-- PROJETO: TO SABENDO
-- SCRIPT DE SETUP FINAL E DE PRODUÇÃO
-- Este script limpa e recria todas as regras de segurança da forma correta e definitiva.
-- =============================================================================

-- =============================================================================
-- ETAPA 1: LIMPEZA COMPLETA E EM CASCATA
-- Remove as funções e TODAS as políticas que dependem delas.
-- =============================================================================
...
-- Garante que nenhuma política com nome conflitante tenha sobrado.
-- =============================================================================
