-- =============================================================================
-- PROJETO: TO SABENDO
-- SCRIPT DE RESET SUPREMO - A SOLUÇÃO DEFINITIVA E ORDENADA
-- =============================================================================

-- =============================================================================
-- ETAPA 1: REMOÇÃO EM CASCATA DAS FUNÇÕES E SUAS POLÍTICAS DEPENDENTES
-- Remove as funções e quebra a corrente de dependência para todas as políticas que as utilizam.
-- =============================================================================
...
-- Agora que as funções foram removidas, podemos seguramente remover qualquer política
-- que possa ter sobrado de migrações antigas ou com nomes conflitantes.
-- =============================================================================
